...
pgn-extract -Tr1-0 chastitywhiterose_lichess.pgn -oall_white_wins_lichess.pgn --checkmate
pgn-extract -Tr0-1 chastitywhiterose_lichess.pgn -oall_black_wins_lichess.pgn --checkmate

pgn-extract -Tr1-0 chastitywhiterose_chesscom.pgn -oall_white_wins_chesscom.pgn --checkmate
pgn-extract -Tr0-1 chastitywhiterose_chesscom.pgn -oall_black_wins_chesscom.pgn --checkmate
