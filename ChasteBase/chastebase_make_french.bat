...
pgn-extract -Twchastitywhiterose -Tr1-0 -xfrench.txt chastitywhiterose_lichess.pgn -o%user%_white_wins_lichess_french.pgn --checkmate
pgn-extract -Tbchastitywhiterose -Tr0-1 -xfrench.txt chastitywhiterose_lichess.pgn -o%user%_black_wins_lichess_french.pgn --checkmate
