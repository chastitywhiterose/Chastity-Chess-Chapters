...
pgn-extract -Twchastitywhiterose -Tr1-0 chastitywhiterose_lichess.pgn -o%user%_white_wins_lichess.pgn --checkmate
pgn-extract -Tbchastitywhiterose -Tr0-1 chastitywhiterose_lichess.pgn -o%user%_black_wins_lichess.pgn --checkmate

pgn-extract -TwChastityWhiteRose -Tr1-0 chastitywhiterose_chesscom.pgn -o%user%_white_wins_chesscom.pgn --checkmate
pgn-extract -TbChastityWhiteRose -Tr0-1 chastitywhiterose_chesscom.pgn -o%user%_black_wins_chesscom.pgn --checkmate
