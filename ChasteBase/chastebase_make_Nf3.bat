...
pgn-extract -Twchastitywhiterose -Tr1-0 -xqueengambit_Nf3.txt chastitywhiterose_lichess.pgn -o%user%_white_wins_lichess.pgn --checkmate
pgn-extract -TwChastityWhiteRose -Tr1-0 -xqueengambit_Nf3.txt chastitywhiterose_chesscom.pgn -o%user%_white_wins_chesscom.pgn --checkmate
